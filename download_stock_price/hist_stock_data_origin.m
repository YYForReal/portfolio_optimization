...
% This one works 20191230
%stocks = hist_stock_data('01012000','01012018','tickers_Nikkei.txt','frequency','wk')
% NOTE
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         
%Esta sección comentada es la que se sustituy?por la sección anterior        
